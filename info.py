...
SESSION = environ.get('SESSION', 'Moviesreqfilter')
API_ID = int(environ.get('API_ID', '25356202'))
API_HASH = environ.get('API_HASH', 'd65d4aa3f001d165ce52acb7bcbe153f')
BOT_TOKEN = environ.get('BOT_TOKEN', "5895816466:AAEIMil8iUBxZjK-YPngbELLP11Ot3IWXh0")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '--1001706630064').split()]
...
# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://pwnjatt:pwnjatt@cluster0.pgk0ow7.mongodb.net/?retryWrites=true&w=majority")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/prsupportgroup')
MSG_ALRT = environ.get('MSG_ALRT', 'Share and Support Us')

# Custom Chats
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', -1001855763630))
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001899774187))
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 'https://t.me/+ZwTTBbvzrHZmODA9')
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/+KxXDuxPYkV5mOTE1')

# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001861413841))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001881440140))
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '624ac0ceba8eecd5928ab828952664b6b38fef66')
